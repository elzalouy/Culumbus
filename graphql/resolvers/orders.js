...
module.exports = {
  makeOrder: (args, req) => {
    ...
    return axios
      .get(
        `${musementUrl}login?client_id=${musement_client_id}&client_secret=${musement_client_secret}&grant_type=client_credentials`
      )
      .then(function (response) {
        let token = response.data.access_token;

        return axios
          .post(`${musementUrl}carts`, {
            headers: {
          ...
          .then(function (response) {
            ...
            return axios
              ...
              .then(function (response) {
                return axios
                  .patch(`${musementUrl}carts/${cartID}`, args.data.user, {
                    headers: {
                      Authorization: "Bearer " + token,
                      "X-Musement-Currency": "USD",
                    },
